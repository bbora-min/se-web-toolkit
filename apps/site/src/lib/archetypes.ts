...
export const ARCHETYPES: Archetype[] = [
  { id: 'ledger', name: '목록', en: 'List & detail', when: '같은 종류의 항목이 수백 개 있고, 찾아서 하나를 열어 보는 화면입니다.', shape: '필터 바 · 표 · 오른쪽 상세 패널', app: 'job-monitor', appName: 'Job Monitor', path: '/jobs', parts: ['DataTable', 'FilterBar', 'ListDetail', 'PageHeader'], refs: ['Linear', 'Vercel', 'Stripe Dashboard'], since: '0.1.0', shot: ledger },
  ...
  { id: 'wall', name: '대시보드', en: 'Dashboard', when: '지금 상태가 괜찮은지 3초 안에 파악하는 화면입니다. 숫자와 추세가 중심입니다.', shape: '12칸 타일 격자 · 차트 · 상태 띠', app: 'job-monitor', appName: 'Job Monitor', path: '/overview', parts: ['TileGrid', 'Tile', 'StatCard', 'ChartLegend', '@se/charts'], refs: ['Grafana', 'Datadog', 'Vercel Analytics'], since: '0.12.0', shot: wall },
  ...
  { id: 'triage', name: '처리함', en: 'Triage', when: '내 차례인 항목을 하나씩 처리하는 화면입니다. 결정이 주된 동작입니다.', shape: '대기열 · 대상 · 결정 패널의 3단 구성', app: 'release-desk', appName: 'Release Desk', path: '/approvals', parts: ['SplitPane', 'ShellFill', 'DecisionDialog 패턴'], refs: ['Gmail', 'Superhuman', 'PagerDuty'], since: '0.15.0', shot: triage },
