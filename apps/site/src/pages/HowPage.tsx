      ...
      <DocLayout toc={<TableOfContents items={TOC} />}>
        ...
        <Prose>
          ...
          <section id="archetype">
            <h2>골격이 구조를 정합니다</h2>
            <p>아이덴티티는 겉모습입니다. 색만 바꾸면 세 서비스가 "사이드바 · 제목 · 필터 · 표"로 똑같아집니다. 그래서 화면마다 골격을 먼저 고릅니다 — 원장·허브·관측 벽·보드·문서·트리아지·콘솔·일정·캔버스·대화. 골격마다 실제로 동작하는 원본 화면이 있고, <code>/se:page</code>는 백지가 아니라 그 원본을 복사해 새 화면으로 바꿔 씁니다.</p>
