...
| P3 배포 | **Storybook·아이덴티티 갤러리 (완료, 0.7.0)** · `@se/*` npm 배포(→ 모노레포 밖 `npx create-se-app`) · 스크린샷 기준 비교 CI · React 18 CI 레인 · codemods · 자동 업그레이드 PR · 기여 가이드 | 웹 비전공 구성원이 혼자 서비스 1개 출시 |
