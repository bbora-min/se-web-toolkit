...
|---|---|---|---|---|
| 액센트 hue | 브랜드 호환 밴드(채도·명도 고정, hue 자유). **레지스트리에서 기존 서비스와 30° 이상**, **의미 색(danger≈30°·warning≈70°·success≈155°·info≈260°)과 18° 이상** 떨어져야 함 — 가까우면 액센트 칩이 경고/오류처럼 읽힌다(Dataset Explorer에 호박 45°를 줬다가 실제로 겪음) | 청록 195° | 자두 310° | 청록빛 초록 150° |
