...
export function TaskNode({ data, selected }: NodeProps & { data: TaskNodeData }) {
  return (
    ...
    >
      <Handle type="target" position={Position.Left} className="!size-2 !border-line-strong !bg-surface" />
      ...
      <Handle type="source" position={Position.Right} className="!size-2 !border-line-strong !bg-surface" />
    </div>
  )
}
