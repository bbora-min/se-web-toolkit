...
export { FacetGroup, type FacetGroupProps, type FacetOption } from './components/facet-group'
...
export { AppShell, NavItem, NavSection, PageHeader, SectionHeader, PageBody, ShellFill, ThemeToggle, useShellLayout, useShellSearch, useContentWidth, type AppShellProps, type ShellLayout, type ShellFillProps } from './patterns/app-shell'
...
export { CalendarGrid, monthDays, ymd, type CalendarGridProps, type CalendarEvent, type CalendarSpan, type CalendarTone } from './patterns/calendar-grid'
