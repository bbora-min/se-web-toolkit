// 원본: examples/dataset-explorer/src/pages/domains/DomainPage.tsx (자동 복사 — 수정하지 말 것, pnpm gen:skill-docs)
/**
 * 도메인 가이드 — 문서(document) 골격의 원본. 좌측 트리(도메인 → 데이터셋) · 중앙 본문 · 우측 목차.
 *
 * 디자인 플랜
 *  골격       : 문서. 같은 앱의 데이터셋 목록(목록)·상세(DetailPage)와 달리 "읽는 화면"이다 — 타이포와 여백이 전부. 크롬(제목 바·필터·표)은 없다.
