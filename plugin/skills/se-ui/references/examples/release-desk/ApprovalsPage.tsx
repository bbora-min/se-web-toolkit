// 원본: examples/release-desk/src/pages/approvals/ApprovalsPage.tsx (자동 복사 — 수정하지 말 것, pnpm gen:skill-docs)
/**
 * 내 승인 대기 — 처리함(3단) 골격의 원본. 목록 | 본문 | 속성. 제목 없음, j/k 로 다음 항목.
 *
 * 디자인 플랜
 *  골격       : 처리함. "하나씩 처리하는" 화면이라 목록을 떠나지 않는다 — 목록(표 → 상세 페이지)과 달리 상세가 옆에 상주한다.
