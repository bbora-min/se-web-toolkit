// 원본: examples/release-desk/src/pages/calendar/CalendarPage.tsx (자동 복사 — 수정하지 말 것, pnpm gen:skill-docs)
/**
 * 배포 캘린더 — 일정(schedule) 골격의 원본. 월 격자 + 프리즈 빗금 + 고른 날의 배포 창 목록.
 *
 * 디자인 플랜
 *  골격       : 일정. 시간이 x축이다 — 같은 릴리스를 표(목록)·보드(흐름)로도 보지만 "언제"는 여기서만 답한다. 프리즈 배너가 여기선 빗금 구간이 된다.
