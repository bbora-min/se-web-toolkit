// 원본: examples/release-desk/src/pages/releases/ReleasesBoard.tsx (자동 복사 — 수정하지 말 것, pnpm gen:skill-docs)
/**
 * 릴리스 보드 — 보드(Kanban) 골격의 원본. 열 = 단계, 카드 = 릴리스.
 *
 * 디자인 플랜
 *  골격       : 보드. 같은 목록을 표(목록)와 보드로 오간다 — "비교할 땐 표, 흐름을 볼 땐 보드". 단계 레일(시그니처)의 숫자를 누르면 그 열로 스크롤한다.
